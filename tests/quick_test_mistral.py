#!/usr/bin/env python
"""Quick test to verify Mistral integration is working."""
...
print(f"✓ MISTRAL_API_KEY present: {bool(api_key)}")

if not api_key:
    print("❌ MISTRAL_API_KEY not found in environment")
    print("Add MISTRAL_API_KEY=your_key to your .env file")
    sys.exit(1)
...
try:
    ...
    print(f"✓ MistralClient created: model={client.model}")
...
try:
    ...
    response = client.complete(
        'Say "Hello from Mistral!" and nothing else.',
        temperature=0.3,
        max_tokens=50
    )
...
try:
    ...
    response = client.complete_json(
        'Return a JSON object with fields: message="Hello from Mistral", status="ok"',
        temperature=0.3,
        max_tokens=100
    )
...
print("\n" + "=" * 60)
print("✅ All tests passed! Mistral integration is working.")
print("=" * 60)
